...
function setupLayer(layer){
    ...
    if(layers[layer].overflow === undefined) layers[layer].overflow = new Decimal(1/0)
    if(layers[layer].overflowPower === undefined) layers[layer].overflowPower = new Decimal("0.5")
